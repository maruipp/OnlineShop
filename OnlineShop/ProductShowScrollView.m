...
@implementation ProductShowScrollView
- (void) dealloc
{
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        //图片滚动控制
        pageControl  =   [[UIPageControl alloc] initWithFrame:CGRectMake(125, 180, 70, 13)];
        ...
        //[self.superview.superview addSubview:pageControl];
        autoScrollFlag  =   YES;
...
- (void) setImages:(NSArray *) imageArray
{
    ...
    for (int i = 0; i < [imageArray count]; i++) {
        ...
        view.frame = CGRectMake(85 + 160 * i, 20, 150, 150);
    ...
    self.contentSize = CGSizeMake(170 + 160 * total, 200);
...
-(void) changePic
{
    ...
    //标识正在自动滚动图片
    autoScrollFlag = YES;
    [self setContentOffset:CGPointMake(160 * pageControl.currentPage, 0) animated:isAnimated];
